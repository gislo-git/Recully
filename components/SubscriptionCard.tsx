...
const SubscriptionCard = ({name, expanded,onPress,startDate, paymentMethod, status,category, plan, renewalDate, price,currency,icon,billing,color}:SubscriptionCardProps) => {
  return (
